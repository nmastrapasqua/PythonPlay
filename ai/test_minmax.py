...
class TestMinMax(unittest.TestCase):
    ...
    def test_tree_1(self):
        game, expected_score, expected_move = get_tree_1_game()
        score, move = find_best_move(game)
        self.assertEqual(score, expected_score)
        self.assertEqual(move, expected_move)

    def test_tree_2(self):
        game, expected_score, expected_move = get_tree_2_game()
        score, move = find_best_move(game)
        self.assertEqual(score, expected_score)
        self.assertEqual(move, expected_move)

    def test_tree_3(self):
        game, expected_score, expected_move = get_tree_3_game()
        score, move = find_best_move(game)
        self.assertEqual(score, expected_score)
        self.assertEqual(move, expected_move)

    def test_tree_4(self):
        game, expected_score, expected_move = get_tree_4_game()
        score, move = find_best_move(game)
        self.assertEqual(score, expected_score)
        self.assertEqual(move, expected_move)
